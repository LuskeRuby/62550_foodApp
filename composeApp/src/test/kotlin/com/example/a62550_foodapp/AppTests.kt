...
class ThemeViewModelTest {
    ...
    @Test
    fun testThemeViewModelBackgroundColors() {
        val theme = ThemeViewModel()

        assertNotNull(theme.backgroundColor)
        assertNotNull(theme.surfaceColor)
        assertNotNull(theme.fadedBackground)

        assertEquals(Color(0xFFF5F5F5), theme.backgroundColor)
        assertEquals(Color(0xFFFFFFFF), theme.surfaceColor)
        assertEquals(Color(0xFFDEDEDE), theme.fadedBackground)
    }

    @Test
    fun testThemeViewModelBrandColors() {
        val theme = ThemeViewModel()

        assertEquals(Color(0xFF4CAF50), theme.primaryColor)
        assertEquals(Color(0xFFFFFFFF), theme.onPrimaryColor)

        assertEquals(Color(0xFFF5F5F5), theme.secondaryColor)
        assertEquals(Color(0xFF333333), theme.onSecondaryColor)
    }

    @Test
    fun testThemeViewModelTextColors() {
        val theme = ThemeViewModel()

        assertEquals(Color(0xFF212121), theme.textPrimary)
        assertEquals(Color(0xFF757575), theme.textSecondary)
        assertEquals(Color(0xFF757575), theme.greyedOutColor)

        assertEquals(theme.greyedOutColor, theme.grayedOutColor)
    }

    @Test
    fun testThemeViewModelNavigationColors() {
        val theme = ThemeViewModel()

        assertEquals(Color(0xFFFFD59A), theme.navBarColor)
        assertEquals(Color(0xFF000000), theme.onNavBarColor)
    }

    @Test
    fun testThemeViewModelButtonColors() {
        val theme = ThemeViewModel()

        assertEquals(Color(0xFF4CAF50), theme.addButtonColor)
        assertEquals(Color(0xFF388E3C), theme.successColor)
        assertEquals(Color(0xFFD32F2F), theme.confirmDeleteColor)
        assertEquals(Color(0xFF757575), theme.cancelButton)
    }

    @Test
    fun testThemeViewModelPriceColors() {
        val theme = ThemeViewModel()

        assertEquals(Color(0xFFE64A19), theme.priceTagColor)
        assertEquals(Color(0xFF269900), theme.totalPriceColor)
    }

    @Test
    fun testThemeViewModelStatusColors() {
        val theme = ThemeViewModel()

        assertEquals(Color(0xFFD32F2F), theme.errorColor)
    }

    @Test
    fun testThemeViewModelRecipeColors() {
        val theme = ThemeViewModel()

        assertEquals(Color(0xFFF3E5F5), theme.cardBackgroundColor)
        assertEquals(Color(0xFF4A90E2), theme.softFabColor)
    }

    @Test
    fun testThemeViewModelCategoryColors() {
        val theme = ThemeViewModel()

        assertEquals(Color(0xFF996600), theme.dryGoods)
        assertEquals(Color(0xFFD32F2F), theme.meat)
        assertEquals(Color(0xFF388E3C), theme.vegetables)
        assertEquals(Color(0xFF1976D2), theme.dairy)
        assertEquals(Color(0xFF6A1B9A), theme.kolonial)
        assertEquals(Color.Gray, theme.other)
    }
}
